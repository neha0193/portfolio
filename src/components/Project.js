  ...
  return (
    <div>
      ...
      <div className='card'>
        ...
        <Card photo={fig3} title= "Weather app" description="Weather app with API" url="https://wheather-app-ochre-nu.vercel.app/" />
        <Card photo={fig2} title= "To-do App" description="A simple To-do lsit App" url="https://to-do-app-sigma-lake.vercel.app/" />
        <Card photo={fig4} title= "One click Download" description="App to download basic files" url="https://easy-downloads.vercel.app/" />
      </div>
      <br/>
